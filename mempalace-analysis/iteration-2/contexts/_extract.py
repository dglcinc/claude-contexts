#!/usr/bin/env python3
"""Task 3 (wing_contexts) — mechanical extraction for F-A and F-C.
...
SOURCES = [
    os.path.expanduser('~/.claude/projects/-Users-utilityserver-github-claude-contexts'),
]
...
def main():
    ...
    out = []
    out.append('# contexts extraction dump (Task 3)')
    out.append('')
    ...
    out.insert(out.index('## DELIVERABLE 2 — F-A INTERRUPT TRIPLES') + 1,
               f"\nTotal interrupts found across contexts: {total_int}")
