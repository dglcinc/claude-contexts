...
- **Branch:** `docs/user-guide` (pushed to origin). Open upstream PR **[sbender9/Wilhelm #99](https://github.com/sbender9/Wilhelm/pull/99)** "docs: in-app documentation source picker + external docs repo" → targets `development`, ~20 commits, **awaiting Scott's review.**
